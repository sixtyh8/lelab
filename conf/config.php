...
if($_conf['translation']['lang'] == 'en'){
	if($_SERVER['REQUEST_URI'] == $_conf['path']['base_url']) $_conf['translation']['switch_lang'] = $_conf['translation']['url_fr'];
	else $_conf['translation']['switch_lang'] = str_replace('/en/', '/fr/', $_SERVER['REQUEST_URI']);
}
else{
