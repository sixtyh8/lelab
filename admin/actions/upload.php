...
if(isset($_POST))
{
    ...
    $SmallPrefix            = "small_";
    $DestinationDirectory   = $_SERVER['DOCUMENT_ROOT']."/img/credits/"; //Upload Directory ends with / (slash)
    $Quality                = 90;
    $response               = array();
    $filename               = removeQuotes($_FILES['ImageFile']);
    ...
    if(resizeImage($CurWidth,$CurHeight,$BigImageMaxSize,$DestRandImageName,$CreatedImage,$Quality,$ImageType))
    {
        ...
        */
        ...
        $response['image'] = $ThumbPrefix.$NewImageName;
